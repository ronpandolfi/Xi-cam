...
class TomoToolbar(QtGui.QToolBar):
    ...
    def __init__(self, parent):
        ...
        icon0 = QtGui.QIcon()
        icon0.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/roi.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/norm.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/cor.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/stripes.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/rings.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/phase.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/filter.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/recon.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/mask.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        # icon9 = QtGui.QIcon()
        # icon9.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/preview.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/wizard.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.unimplemented_actions = (self.actionROI, self.actionNorm, self.actionCOR,
...
class ExplorerToolbar(QtGui.QToolBar):
    ...
    def __init__(self, parent=None):
        ...
        icon0 = QtGui.QIcon()
        icon0.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/open.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen.setIcon(icon0)
        self.actionOpen.setObjectName('actionOpen')
        self.actionOpen.setToolTip('Open dataset')
        self.actionDelete = QtGui.QAction(self)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/delete.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDelete.setIcon(icon1)
        self.actionDelete.setObjectName('actionDelete')
        self.actionDelete.setToolTip('Delete dataset')
        self.actionUpload = QtGui.QAction(self)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/upload.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/transfer.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap('xicam/plugins/tomorex/gui/download.png'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
