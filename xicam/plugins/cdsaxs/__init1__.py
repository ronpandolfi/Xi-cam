...
class CDSAXSWidget(QtGui.QTabWidget):
    ...
    def loadRAW(self, Phi_min = -45 , Phi_max = 45, Phi_step = 1):
        ...
        self.QxyiData = cdsaxs.generate_carto(profiles, nb_pixel, Phi_min, Phi_step, pixel_size, sample_detector_distance, wavelength, center[0])
        ...
        self.q, self.Qxexp, self.Q__Z = cdsaxs.find_peaks(profile_carto, self.QxyiDatacor, wavelength, nb_pixel, pixel_size, sample_detector_distance)
...
class CDSAXSWidget(QtGui.QTabWidget):
    ...
    def fitting_test1(self, H=10, LL=20, Beta1=70, Num_trap=5, DW=0.1, I0=1, Bk=0):  # these are simp not fittingp
        ...
        self.mcmc(N=len(self.best_corr), sigma=1000, nsteps=1000, nwalkers=100, use_mh='MH', parallel=False, seed=None,
                  verbose=True)
        print('Done')
        '''
        elif algorithm == 'mcmc':
