...
setup(
    ...
    install_requires=['numpy', 'scipy', 'cython', 'fabio', 'pyFAI', 'h5py', 
                      'shiboken', 'PySide', 'PyQtGraph', 'QDarkStyle', 
                      'nexusformat', 'Pillow', 'pyfits', 'PyOpenGL', 'PyYAML', 
                      'qtconsole', 'tifffile', 'pysftp', 'requests']
