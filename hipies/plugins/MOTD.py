...
class plugin(base.plugin):
    ...
    MOTD = """<div align='center'><img src='{}/gui/camera.jpg' width='200'/><h1>Weclome to Xi-cam</h1><br />Please cite Xi-cam in published work: <br />Pandolfi, R., Kumar, D., Venkatakrishnan, S., Hexemer, A.
