...
paths = glob.glob('/Users/austinblair/Downloads/test_20150714_144045/*[0-9][0-9][0-9][0-9]_0000_[0-9][0-9][0-9][0-9]_[0-9][0-9][0-9][0-9]_model.tif')
for path in paths:
    if "final" in path:
        continue
...
paths = glob.glob('/Users/austinblair/Downloads/test_20150714_144045/*[0-9][0-9][0-9][0-9]_0001_[0-9][0-9][0-9][0-9]_[0-9][0-9][0-9][0-9]_model.tif')
for path in paths:
    if "final" in path:
        continue
    im = Image.open(path).convert('L')
...
paths = glob.glob('/Users/austinblair/Downloads/test_20150714_144045/*[0-9][0-9][0-9][0-9]_0002_[0-9][0-9][0-9][0-9]_[0-9][0-9][0-9][0-9]_model.tif')
for path in paths:
    if "final" in path:
        continue
    im = Image.open(path).convert('L')
